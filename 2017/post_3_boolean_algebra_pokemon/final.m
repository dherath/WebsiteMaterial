...
figure;
subplot(231);imshow(temp_r);axis image;title('Red channel (R)');
subplot(232);imshow(temp_g);axis image;title('Green channel (G)');
subplot(233);imshow(temp_b);axis image;title('Blue channel (B)');
...
subplot(235);imshow(final_image);axis image;title('Final Output (RGB)');
